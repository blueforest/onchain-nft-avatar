          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Manage your NFT avatars and view your collection
              </p>
            </div>
            <WalletConnect />
          </div>
          ...
          {!isConnected ? (
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Connect your MetaMask wallet to view your NFT collection.
              </p>
            </div>
          ) : (
            <div className="text-center py-12">
        ...
        <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <span className="text-gray-700 dark:text-gray-300">Mint NFT</span>
            </button>
            <button 
              className="flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={!isConnected}
            >
              ...
              <span className="text-gray-700 dark:text-gray-300">View Gallery</span>
            </button>
